    ...
    <div id="content-wrapper">
      <div class="container-fluid">
        ...
        <body>
          ...
          $try = "SELECT COUNT(*) AS res FROM tmpevent WHERE department = 'EDUCATION' and tmpevent.id ='".$_SESSION['student_id_for_attendance']."' ";
          ...
          while($row = mysqli_fetch_array($tryres))
          {
            ...
            if($start == 0)
            {
              ...
              WHERE tmpevent.id = tmpparticipants.event_id AND department = 'EDUCATION' and tmpevent.id ='".$_SESSION['student_id_for_attendance']."'
                        ...
                        if(($date >= $start) && ($date <= $end))
                        {
                          ...
                          //$totaleqv = ($first_eqv + $second_eqv + $third_eqv + $fourth_eqv);
                            ...
                            $time >= $fourth_start && $time <= $fourth_end)
                            {
                              ...
                              echo "<br>";
                              echo "<input onmousedown='bleep.play()' type='submit' name='education' hidden>";
